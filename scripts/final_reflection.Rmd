...
cd_cartogram <- read_sf("/Users/hwalker/Desktop/Senior Fall/Election Analytics/electionanalytics/data/reflection/HexCDv30/HexCDv30.shp")

cd_cartogram = left_join(cd_cartogram, merge_w_map, by=c("STATENAME","CDLABEL"))

ggplot() + 
  geom_sf(data=cd_cartogram,aes(fill=prediction),
...
ggplot() + 
  geom_sf(data=cd_cartogram,aes(fill=actual),
          inherit.aes=FALSE,alpha=1) + 
  scale_fill_gradient(low = "red", high = "blue", limits=c(0,100)) +
...
ggplot() + 
  geom_sf(data=cd_cartogram,aes(fill=missed),
          inherit.aes=FALSE,alpha=1) + 
